...
public class Decoder {
  ...
  private String decode(OpCode opCode) {
    ...
    return switch (opCode) {
      ...
      case load_0, load_1, load_2, load_3, store_0, store_1, store_2, store_3, const_0, const_1, const_2, const_3,
           const_4, const_5, const_m1, add, sub, mul, div, rem, neg, shl, shr, aload, astore, baload, bastore,
           arraylength, pop, dup, dup2, exit, return_, read, print, bread, bprint -> opCode.cleanName();
