...
public class SymbolTableTest extends BaseCompilerTestCase {
  ...
  public void undefMeth() {
    ...
    expectError(1, 33, NOT_FOUND, "foo");
  ...
  public void singletonDecl() {
    ...
    expectSymTab("Program Test:");
    expectSymTab("  Method: void <clinit> (0 locals, 0 parameters)");
    expectSymTab("  Global Variable 0: class (1 fields) Math");
    expectSymTab("  Global Variable 1: class (5 fields) Workdays");
    expectSymTab("  Method: void main (0 locals, 0 parameters)");
    parseVerifyVisualize();
  }

  @Test
  public void singletonValidAccess() {
    initCode("""
            program Test
              singleton Math { int PI; } (3)
              singleton Workdays { int Mon, Tue, Wed, Thu, Fri; }
    ...
    expectSymTab("  Global Variable 1: class (5 fields) Workdays");
    expectSymTab("  Method: void main (2 locals, 0 parameters)");
    expectSymTab("    Local Variable 0: int radius");
    expectSymTab("    Local Variable 1: int area");
    parseVerifyVisualize();
  }

  @Test
  public void singletonInvalidAccess() {
    initCode("""
            program Test
              singleton Math { int PI; } (3)
              singleton Workdays { int Mon, Tue, Wed, Thu, Fri; }
    ...
    expectError(13, 18, NO_FIELD, "Sat");

    parseVerifyVisualize();
  }

  @Test
  public void singletonGlobalVar() {
    initCode("""
            program Test
              singleton Math { int PI; } (3)
              singleton Workdays { int Mon, Tue, Wed, Thu, Fri; }
            ...
            """);
    expectError(4, 12, NO_TYPE);
    parseVerifyVisualize();
  }

  @Test
  public void singletonLocalVar() {
    initCode("""
            program Test
              singleton Math { int PI; } (3)
              singleton Workdays { int Mon, Tue, Wed, Thu, Fri; }
  ...
  public void singletonConstructor() {
    initCode("""
            ...
            """);
    expectError(6, 21, NO_TYPE);
    parseVerifyVisualize();
  }

  @Test
  public void noFieldWithArray() {
    initCode("""
            program Test
              class C { }
            {
    ...
    expectError(5, 18, NO_FIELD, "field");
    parseVerifyVisualize();
  }
}
